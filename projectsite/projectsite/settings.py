...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'django-insecure--(6bj1qta*oohad_(7v0g!t0p++yuwy_y(awt2b^+j8cgn8#hs')

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = os.environ.get('DJANGO_DEBUG', 'True') == 'True'

ALLOWED_HOSTS = [ 'localhost', '127.0.0.1', 'mikopatindol.pythonanywhere.com' ]
